...
```{r}
pacman::p_load(sf, spdep, tmap, tidyverse, readxl, ggplot2, moments, 
               plotly, sfdep, Kendall, lubridate, anytime)
```
...
all.linked <- max(unlist(nbdists(k1, coords, longlat = FALSE)))
summary(k1dists)
```
